  ...
  try {
    ...
    highUsageOrgs?.forEach(org => {
      ...
      if (totalMinutes > 2000) {
        alerts.push({
          ...
          organizationName: Array.isArray(org.organization) ? org.organization[0]?.name : org.organization?.name,
    ...
    failedPayments?.forEach(payment => {
      alerts.push({
        ...
        organizationName: Array.isArray(payment.organization) ? payment.organization[0]?.name : payment.organization?.name,
